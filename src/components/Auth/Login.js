  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-md">
      ...
      <button
        onClick={handleLogin}
        disabled={loading}
        className="flex items-center justify-center w-full py-2 px-4 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded transition duration-150 disabled:opacity-50"
      >
        {loading ? (
          <span className="mr-2">
      ...
      <p className="mt-4 text-sm text-gray-600">
        Sign in with your GitHub account to manage your project dashboard.
      </p>
    </div>
  );
}
