    ...
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center">
        <div className="text-center">
          <p className="text-slate-400 mb-4">{error || "Run not found"}</p>
          <Link href="/scout">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <Card className="bg-slate-900 border-slate-800 p-3">
                <div className="text-[10px] text-slate-500 uppercase tracking-wider">Evaluated</div>
                <div className="text-sm font-bold text-white">{run.projectsEvaluated || 0}</div>
              </Card>
              <Card className="bg-slate-900 border-slate-800 p-3">
                <div className="text-[10px] text-slate-500 uppercase tracking-wider">Backed</div>
          ...
          <section>
            <details className="group">
              <summary className="text-xs font-bold text-slate-500 uppercase tracking-widest cursor-pointer hover:text-slate-300 transition-colors flex items-center gap-2">
