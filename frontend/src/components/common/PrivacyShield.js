  ...
  const steps = [
    {
      ...
      visual: (
        <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-xs font-mono text-red-700">
          <div className="text-[10px] text-red-500 uppercase mb-1">Solana Explorer — Public</div>
    ...
    },
    {
      ...
      visual: (
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-xs font-mono text-green-700">
          <div className="text-[10px] text-green-500 uppercase mb-1">Solana Explorer — Shielded</div>
          ...
          <div className="text-[10px] text-green-600 mt-1">Valid proof verified — details hidden 🔒</div>
        </div>
      ),
    },
    {
      ...
      visual: (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-purple-900">Privacy-First Platform</p>
              <p className="text-xs text-purple-700">Your data. Your positions. Protected by zero-knowledge proofs.</p>
            </div>
          </div>
        </div>
      ),
      ...
      <div className="p-5">
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 mt-1 leading-relaxed">{current.body}</p>
          </div>
        </div>
...
export function PrivacyBadge({ className = '' }) {
  return (
    <span className={`inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 border border-purple-200 ${className}`}>
