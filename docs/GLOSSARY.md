...
|------|----------|------------|
| **Backer** | Role | User who stakes USDC on builders projects to earn rewards |
| **Bags** | Product | Solana token-launch mechanism — Rail 1 in the capital stack. Community capital through fee-share tokens. |
| **Builder** | Role | Developer who submits projects for funding, completes milestones, and wins hackathon prizes |
...
| **Rail** | Product | A capital instrument — one of three (Bags Token, x402 Credit Line, Prize Routing) |
| **Scout** | Agent | AI agent that discovers high-potential projects matching a backer's thesis. $0.01/call. |
